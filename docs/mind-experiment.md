...
- Deterministic spherical layout: the user stays at the origin, while Fibonacci directions and varying radii distribute records in all three dimensions. Saved relationships do not influence positions or node sizes. Positions remain stable while filtering. Rendering occurs on demand.
