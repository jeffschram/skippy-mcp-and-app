...
export const attentionStatus = v.union(v.literal("immediate"), v.literal("todo"), v.literal("in_progress"), v.literal("scheduled"), v.literal("ok"), v.literal("stale"), v.literal("unassessed"));
