...
export default defineSchema({
  ...
  // Conversational chat transcript (the lightweight path — no run machinery).
  // Assistant replies are generated by an LLM action; the pending row is
  // patched in place when the reply lands, so the UI renders "thinking" state
  // reactively.
